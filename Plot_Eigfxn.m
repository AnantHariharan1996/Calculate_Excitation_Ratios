...
for ijk = 1:length(Periods2Find)
    ...
    if RayleighOrLove
        figure(ijk)
        plot(10*U,(6371000-r)./1000,'-r','linewidth',2)
        hold on
        plot(Uderiv,(6371000-r)./1000,'-r','linewidth',2,'linestyle','--')
        plot(10*V,(6371000-r)./1000,'-b','linewidth',2)
        plot(Vderiv,(6371000-r)./1000,'-b','linewidth',2,'linestyle','--')
        legend('10 \times U','U''','10 \times V','V''','location','southeast')
    elseif RayleighOrLove==0
        figure(ijk)
        plot(10*W,(6371000-r)./1000,'-m','linewidth',2)
        hold on
        plot(Wderiv,(6371000-r)./1000,'-m','linewidth',2,'linestyle','--')
    ...
    titlestr = [modename ' Eigenfunctions for ' replace(Velmod,'_','\_') ', n = ' ...
        num2str(currN) ', Period = ' num2str(BestPeriod) 's'];
    title(titlestr)
end